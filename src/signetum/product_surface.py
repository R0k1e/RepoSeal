...
from signetum.change.models import FrozenModel, require_relative_path
...
REQUIRED_PRODUCT_PATHS = (
    ...
    "SECURITY.md",
    "LICENSE",
    "assets/brand/signetum-mark.png",
    "assets/brand/signetum-mark-512.png",
    "assets/brand/signetum-mark-256.png",
    "assets/brand/signetum-mark-128.png",
    "assets/brand/signetum-mark-64.png",
    "assets/brand/signetum-mark-32.png",
    "assets/brand/signetum-social-preview.png",
    "site/index.html",
    ...
    "docs/product/why-signetum.md",
    "docs/product/frequently-asked-questions.md",
    "docs/product/signetum-and-specification-tools.md",
...
REQUIRED_PRODUCT_CONTENT = {
    "README.md": ("# Signetum", "Seal every change with evidence"),
    "QUICKSTART.md": ("Signetum",),
    "docs/product/why-signetum.md": ("# Why Signetum exists",),
    "docs/product/frequently-asked-questions.md": ("## What is Signetum?",),
}
